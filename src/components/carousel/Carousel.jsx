...
const images = [
  {
    ...
    link: "/movieDetails/queen-of-tears", // Specify link for each image
  },
  {
    src: slider2,
    text: (
    ...
    link: "/movieDetails/doctor-slump",
  },
  {
    src: slider0,
    text: (
      <div className="md:mt-[120px]">
        ...
        <p className="md:w-[535.35px] md:pl-4 italic md:leading-[21.79px] font-normal md:text-[16px] text-[8px]">
          ...
          horrific, unfathomable, and despicable way.
        </p>
      </div>
    ),
    link: "/movieDetails/the-escape-of-the-seven",
  },
];
...
function Carousel() {
  ...
  return (
    <div className="relative w-full md:h-[521px] h-[300px] overflow-hidden font-sans mt-20 bg-black bg-opacity-57">
      ...
      >
        <Link to={images[currentIndex].link} className="w-full h-full">
          <img
